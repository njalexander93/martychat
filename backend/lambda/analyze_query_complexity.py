...
def lambda_handler(event: dict, context: object) -> dict:
    ...
    try:
        ...
        contains_comparison = any(
            ...
            for word in ["compare", "contrast", "difference", "relationship", "versus", "impact"]
        )
        contains_theory = any(
            word in message.lower() for word in ["theory", "concept", "framework", "approach", "model"]
        )
        ...
        return {"statusCode": 200, "headers": CORS_HEADERS, "body": json.dumps({"k": base_k})}
